...
import com.josamuna.notekeeper.NoteKeeperProviderContract.CoursesIdColumns;
import com.josamuna.notekeeper.NoteKeeperProviderContract.Notes;

import static com.josamuna.notekeeper.NoteKeeperProviderContract.AUTHORITY;
...
public class NoteKeeperProvider extends ContentProvider {
    ...
    public String getType(Uri uri) {
        ...
        switch (uriMatch) {
            case COURSES:
                // For multiple rows return vnd.android.cursor.dir/vnd.com.josamuna.notekeeper.provider/courses
                mimeType = ContentResolver.CURSOR_DIR_BASE_TYPE + "/" + MIME_VENDOR_TYPE + Courses.PATH;
                break;
            case NOTES:
                // For multiple rows return vnd.android.cursor.dir/vnd.com.josamuna.notekeeper.provider/notes
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        switch (uriMatch) {
            case NOTES:
                ...
                // content://com.josamuna.notekeeper.provider/notes/1
                rowUri = ContentUris.withAppendedId(Notes.CONTENT_URI, rowId);
                break;
            case COURSES:
                rowId = db.insert(CourseInfoEntry.TABLE_NAME, null, values);
                // content://com.josamuna.notekeeper.provider/courses/0
    ...
    public Cursor query(Uri uri, String[] projection, String selection,
        ...
        switch (uriMatch) {
            ...
            case NOTES_ROW:
                ...
                String[] rowSelectionArgs = new String[] { String.valueOf(rowId) };
